...
# Ricker wavelet source term for the wave equation, returns a 4D tensor (Nt,1,H,W)
...
# Ricker wavelet source term for the wave equation, returns a scalar per point
